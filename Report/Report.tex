...
Typing? Strong/Weak?
\\\\
A previous implementation of GP for snake has been implemented and is available online\cite{snake_blog}, this has been re-written in DEAP and slightly adapted to allow it to work with the available controls (up, down, left, right). This new implementation will be used as a baseline for further improvement. Any changes proposed in this report will be compared against this baseline in order to produce meaningful results.
